...
assert.doesNotMatch(html, /每月1號/);
assert.match(html, /ArrowRight/);
assert.match(html, /aria-describedby="dcaChartSummary"/);
assert.match(html, /最近一期歷史資產/);
const next=nextTradingDate('2026/07/04', {'2026-07-06': 10});
assert.equal(next.date, '2026/07/06');
...
assert.equal(goalScenarios(1000, 0)[0].tooLong, true);
